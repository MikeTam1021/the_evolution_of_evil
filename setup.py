...
APP_NAME = 'The Evolution of Evil'
...
PACKAGEDATA = {
    ...
    'package_dir': {'The Evolution of Evil': 'The Evolution of Evil',
                   },
    'packages': ['The Evolution of Evil',
                ],
    'scripts': ['scripts/The Evolution of Evil'],
}
...
_DATA_DIR = os.path.join('The Evolution of Evil', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'The Evolution of Evil': data_dirs}
...
src = []
add_files(src,os.walk('The Evolution of Evil'))
