#fake Makefile for The Evolution of Evil, to support the common
...
clean:
	...
	rm -f The Evolution of Evil/*~
	rm -rf bin develop-eggs eggs parts .installed.cfg The Evolution of Evil.egg-info
...
# push changes
push:
	#bzr push lp:The Evolution of Evil
	svn commit
